...
if user_choice == '1':
	...
	session = ConnectHandler(device_type = 'cisco_xr', ip = ip, username = username, password = password)
	...
	if user_choice == '1':
		...
		filename = raw_input('\nPlease name your file. Example: /home/ubuntu/xr1.txt: ')
...
#For using this application on other networking vendors, just replace device_type = 'cisco_xr' with any of the following:
