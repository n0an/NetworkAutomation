...
FIREWALL_DIR = '/home/ubuntu/MyFiles/Bonuses/Bonus#05'

# Location of tftproot.
TFTPROOT_DIR = '/tftpboot'

# IP Address of TFTP Server (local IP).
TFTP_HOST = '172.16.1.1'
...
DATABASE_ENGINE = 'sqlite3'   # Choose 'postgresql', 'mysql', 'sqlite3'
DATABASE_NAME = '/home/ubuntu/MyFiles/Bonuses/Bonus#05/acls.db'          # Or path to database file if using sqlite3
